...
const mnemonic =
  "surprise sweet upset clock glory used motor hover cross sight cry evidence";
...
module.exports = {
  ...
  networks: {
    ...
    briing: {
      provider: () =>
        new HDWalletProvider(mnemonic, "https://demo:briing@briing.io/eth"),
      network_id: "53006",
      gas: "0x7a1200",
    },
  },
  mocha: {
    ...
    reporterOptions: {
      currency: "USD",
      coinmarketcap: "81874c1a-a4b3-4755-80ce-19baaac0ea82",
